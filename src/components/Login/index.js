...
import './index.css';
import LogoNetTruyen from './Đăng nhập - NetTruyen_files/logo-nettruyen.png';
const Login = () => {
    return (
        <>
            <div>
                ...
                <>
                    ...
                    <div style={{ display: 'none', width: '1519.2px', height: 41, float: 'none' }} />
                    <main className="main">
                        {/*googleon: all*/}
                        <div className="container">
                            <div id="ctl00_Breadcrumbs_pnlWrapper">
                                <ul className="breadcrumb" itemScope itemType="http://schema.org/BreadcrumbList">
                                    <li itemProp="itemListElement" itemScope itemType="http://schema.org/ListItem"><a href="http://www.nettruyenme.com/" className="itemcrumb active" itemProp="item" itemType="/"><span itemProp="name">Trang chủ</span></a>
                                        <meta itemProp="position" content={2} />
                                    </li>
                                    <li itemProp="itemListElement" itemScope itemType="http://schema.org/ListItem"><a href="http://www.nettruyenme.com/Secure/Login.aspx" className="selectedcrumb">Đăng nhập</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="row">
                                <div id="ctl00_divCenter" className="full-width col-sm-12">
                                    <div id="ctl00_mainContent_pnlLogin">
                                        <div id="ctl00_mainContent_pnlStandardLogin" className="login-wrapper">
                                            <div className="row">
                                                    ...
                                                    <div className="user-page clearfix">
                                                        ...
                                                        <div id="ctl00_mainContent_login1_LoginCtrl_pnlLContainer" className="signup-wrapper" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'ctl00_mainContent_login1_LoginCtrl_Login')">
                                                            <div className="form-group">
                                                                ...
                                                                <input name="ctl00$mainContent$login1$LoginCtrl$UserName" type="text" maxLength={100} id="ctl00_mainContent_login1_LoginCtrl_UserName" tabIndex={10} className="form-control" />
                                                            </div>
                                                            <div className="form-group">
                                                                <label className="control-label">
                                                                    Mật khẩu
                                                                </label>
                                                                <input name="ctl00$mainContent$login1$LoginCtrl$Password" type="password" id="ctl00_mainContent_login1_LoginCtrl_Password" tabIndex={10} className="form-control" placeholder="Mật khẩu" />
                                                                <span className="remember-me hidden"><input id="ctl00_mainContent_login1_LoginCtrl_RememberMe" type="checkbox" name="ctl00$mainContent$login1$LoginCtrl$RememberMe" defaultChecked="checked" tabIndex={10} /><label htmlFor="ctl00_mainContent_login1_LoginCtrl_RememberMe">Ghi
                                                                    nhớ</label></span>
                                                            </div>
                                                        </div>
                                                        <div className="login-action">
                                                            <div className="form-group">
                                                                <input type="submit" name="ctl00$mainContent$login1$LoginCtrl$Login" defaultValue="Đăng nhập" id="ctl00_mainContent_login1_LoginCtrl_Login" tabIndex={10} className="btn btn-primary" />
                                                            </div>
                                                        </div>
                                                    </div>
